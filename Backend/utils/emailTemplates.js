        ...
        <table border="0" cellspacing="0" cellpadding="0" style="width:100%;max-width:620px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#1A1A2E;padding:32px 24px;text-align:center;">
              ...
              <p style="margin:14px 0 0;color:#A7AEC2;font-size:10px;text-transform:uppercase;letter-spacing:1px;">Follow Us</p>
              <p style="margin:6px 0 0;font-size:11px;line-height:1.8;">
                ${SOCIAL_LINKS.map(
                  (link) =>
                    `<a href="${link.href}" style="color:#C9D3FF;text-decoration:none;">${link.label}</a>`
                ).join(`<span style="color:#59607A;"> | </span>`)}
              </p>
