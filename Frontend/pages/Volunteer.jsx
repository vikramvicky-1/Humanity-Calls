...
const Volunteer = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.rolePreference) {
      toast.error("Please select one Role Preference");
      return;
    }
                ...
                <div className="space-y-4 border-t border-gray-100 pt-6 mt-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700 block">
                      A. How can you help us? *
                    </label>
                    <p className="text-xs text-gray-500 mb-2">Describe how you can support our mission (for example: teaching, fundraising, event support, outreach, design).</p>
                    <textarea
                      required
                      name="skills"
                      value={formData.skills}
                      onChange={handleChange}
                      placeholder="Tell us how you can help us"
                      className={inputClasses}
                      rows={3}
                    />
                  </div>
